...
:::note[このページで分かること]
181の業務を18領域に分ける理由と、領域別の一覧だけでは見えない仕事のつながりを理解できます。
:::
...
18領域の内側には181の業務があります。本文では全件を列挙せず、仕事の目的とつながりを理解するために代表的な業務だけを扱います。特定業務を探す場合は、[業務カタログの原本](https://github.com/tsumasaki-kurageya/property-management-pdm/blob/main/docs/building-maintenance-business-catalog.md)を参照してください。

次は[契約から改善まで](./business-lifecycle/)で、領域をまたいで仕事がどのように進むかを見ます。

## まとめ

- ビルメンテナンス会社の仕事は、18領域・181業務として整理できます。
...
- [18領域・181業務をIDや名称から調べる](../reference/business-catalog/)
