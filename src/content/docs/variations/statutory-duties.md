...
まず建物・設備・管理権原と最新法令から適用と義務主体を判定し、資格・体制・期限を計画へ落とします。点検・測定・訓練等の実施後は、結果を判定し、必要な行政報告と証跡保存を行います。不適合があれば是正・再判定へ進み、法改正や物件変更も含めて再び適用判定へ戻ります。

図の根拠：P08、BM-04、BM-05-02・07〜08、BM-07、BM-09-01・04〜06・09〜10、BM-11-07〜08、BM-13-05〜10、BM-14-01〜04、BM-17-08〜10。主な成果物は適用法令一覧、義務主体・実施体制、期限計画、点検等の記録、判定・承認、提出・受理記録、保存証跡、是正記録です。
