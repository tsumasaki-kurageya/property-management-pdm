...
オーナーの方針・投資判断を、PMが物件運営と契約へつなぎ、BMが現場管理と作業履行を担う代表形です。FMは利用側の要求を運用へ渡し、テナント・利用者は依頼や異常を伝えます。専門業者・再委託先は専門範囲を実施しますが、契約上の実施責任、技術確認、成果の検収、費用決定、法的義務は別々に割り当てます。

図の根拠：BM-01〜03、BM-05、BM-10、BM-12〜13、BM-16〜17。主な成果物は要求事項、契約・責任分担、作業指示、専門作業記録、報告書、承認記録です。
