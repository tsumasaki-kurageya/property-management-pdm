...
```mermaid
%%{init: {"flowchart": {"htmlLabels": true, "padding": 20}}}%%
flowchart TB
    A["知りたいことを<br/>自然言語で表す"] --> B["対象と動作に<br/>分解する"]
    B --> C["業務カタログから<br/>業務IDを特定する"]
    C --> D["所属する<br/>業務領域を確認する"]
    D --> E["業務プロセスマップで<br/>上流・下流を確認する"]
    E --> F["関連する別領域へ<br/>探索を広げる"]
    F --> G["条件差・現場手順・責任分界を<br/>必要に応じて確認する"]
```
...
%%{init: {"flowchart": {"htmlLabels": true, "padding": 20}}}%%
flowchart TB
    A["BM-04-03<br/>週間・日次計画を<br/>作成する"] --> B["BM-04-04<br/>作業日を調整する"]
    A --> C["BM-04-05<br/>作業担当者を<br/>割り当てる"]
    B --> D["BM-04-06<br/>協力会社へ作業を<br/>依頼する"]
    C --> D
    D --> E["BM-04-07<br/>作業前連絡を行う"]
    E --> F["BM-04-08<br/>入館・作業申請を<br/>行う"]
```
...
%%{init: {"flowchart": {"htmlLabels": true, "padding": 20}}}%%
flowchart TB
    A["上流情報<br/>契約仕様・初期計画<br/>資格・スキル・シフト"]
    B["作業前調整<br/>作業日・担当者<br/>依頼・連絡・申請"]
    C["実施・結果<br/>現場作業<br/>記録・確認・報告"]
    A --> B --> C
```
