...
契約前の要求確認から立ち上げ、計画、実施、報告、請求、改善へ進みます。改善結果は次の計画へ戻り、契約条件を変える場合は更新・終了の判断へ進みます。したがって、請求で仕事が終わるのではなく、実績が次周期の仕様と計画の入力になります。

図の根拠：P01〜P05、P10〜P12、BM-01〜18。主な成果物は要求事項、契約仕様、初期台帳、作業計画、作業・報告記録、請求・原価情報、改善案、更新条件または終了時引継ぎです。
...
18領域は「仕事の種類」、12プロセスは「複数領域を通って仕事が完了する流れ」です。次の表は、各領域が主に参加するプロセスを示します。すべての個別業務が、記載した全プロセスへ常に参加するという意味ではありません。

| 業務領域 | 主に接続する横断プロセス |
|---|---|
| BM-01 営業・提案 | P01 引き合い・提案・契約 |
| BM-02 契約管理 | P01、P10 実績・請求・原価、P11 分析・改善、P12 契約更新・終了 |
| BM-03 業務立ち上げ | P02 受託立ち上げ |
| BM-04 計画・スケジュール管理 | P03 計画・作業準備、P08 法定業務管理 |
| BM-05 人員・協力会社管理 | P02、P03、P08 |
| BM-06 清掃管理 | P03、P04 定常業務の実施、P09 品質不適合・是正、P11 |
| BM-07 衛生管理 | P04、P08 |
| BM-08 設備運転管理 | P04、P06 異常・修繕・復旧 |
| BM-09 点検・保守管理 | P03、P04、P06、P08 |
| BM-10 不具合・修繕管理 | P06、P11 |
| BM-11 警備・防災管理 | P04、P06、P08 |
| BM-12 テナント・顧客対応 | P03、P06、P07 顧客依頼・苦情対応、P09 |
| BM-13 作業結果・報告管理 | P05 結果確認・報告、P06、P08、P10 |
| BM-14 建物・設備情報管理 | P02、P05、P06、P08 |
| BM-15 資材・在庫・購買管理 | P03、P06、P10 |
| BM-16 売上・請求・原価管理 | P01、P10、P11 |
| BM-17 品質・安全・法令管理 | P01〜03、P05〜06、P08〜09 |
| BM-18 分析・改善・経営管理 | P10〜12 |

表の根拠は、業務プロセスマップで各プロセスに接続された業務IDです。個別業務と順序、判断、成果物を確認する場合は、[分析用原本](https://github.com/tsumasaki-kurageya/property-management-pdm/blob/main/docs/04_mappings/business-process-map.md)を参照してください。
...
- [181業務を領域・ID・名称から調べる](../../reference/business-catalog/)
