...
日次の運転・清掃・巡回・受付で残した記録を、月次の報告・請求・品質確認へ集約します。月次の傾向と実績は、年次の計画・予算・法定期限・契約更新へ渡され、年次計画が再び月次・日次へ分解されます。三つの周期は独立した予定表ではなく、互いに入力と結果を渡す循環です。

図の根拠：BM-04-01〜03、BM-06〜13、BM-16〜18。主な成果物は日誌・作業記録、月間計画・月報・請求資料、年間計画・予算実績・更新条件です。
