...
|---|---|---|---|---|---|
| 要検討 | 勤務・作業の引継ぎ | `PROC-COM-001` | 勤務引継ぎ | 予定 | 警備の勤務交代を含め、直接対応する業務IDがない可能性がある |
...
| 候補 | 現状 | 確認観点 |
|---|---|---|
| 勤務交代・引継ぎ | `PROC-COM-001`と`PROC-SEC-001`に直接対応する業務IDがない | BM-05のシフト管理、BM-13の報告とは異なる独立業務として追加するか |
...
不足候補は直ちにカタログへ追加せず、該当手順を試作して目的、開始条件、完了条件及び成果物が独立するかを確認してから判断する。
