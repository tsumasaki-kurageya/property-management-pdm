...
本ディレクトリは、ビルメンテナンス業務のうち、清掃、設備及び警備の現場作業について、標準的な実施順序、判断、異常時対応、記録及び引継ぎを整理する。
...
| 設備 | BM-08、09、10、13、14、17 | 運転監視、巡回点検、検針、操作、保守、異常・復旧対応 |
| 警備 | BM-11、12、13、17 | 入退館、鍵、巡回、監視、不審者・事故・災害対応 |

衛生管理（BM-07）は設備手順又は清掃手順と接続するが、法定測定、害虫防除、水質管理等の専門手順は、清掃・設備・警備の代表手順を整備した後に拡張する。
...
| 接頭辞 | 区分 | 例 |
|---|---|---|
| `PROC-COM` | 3領域に共通する手順 | `PROC-COM-002` |
...
清掃、設備及び警備の作業内容は異なるが、現場作業の基本的な進行は共通する。
...
設備手順は、監視、現場確認、測定、操作、保守、異常対応及び復旧確認で分解する。
...
| 入退館・鍵 | 受付、本人確認、入館証、貸出、返却、未返却対応 | BM-11-02〜03 |
| 巡回・監視 | 巡回経路、施錠・火気確認、カメラ・警報監視 | BM-11-04〜05 |
| 不審者・事故 | 声掛け、応援要請、負傷者保護、現場保全 | BM-11-06、BM-11-09 |
| 防災 | 火災、地震、風水害、避難誘導 | BM-11-07〜08 |
