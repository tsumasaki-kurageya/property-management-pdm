      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: '3. 維持管理・実行レイヤー', slug: 'management-structure/maintenance-execution' },
            { label: 'ビルメンテナンス（BM）の位置付け', slug: 'management-structure/maintenance-execution/building-maintenance' },
          ],
        },
        {
          label: 'ビルメンテナンス業務を探す',
        ...
        },
        {
          ...
          items: [
            ...
            { label: '所有・利用・契約による責任分界の違い', slug: 'variations/responsibility-boundaries' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { label: '1. 所有・投資管理レイヤー', slug: 'management-structure/ownership-and-investment' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { label: '2. 物件・施設運営レイヤー', slug: 'management-structure/property-and-facility-operation' },
