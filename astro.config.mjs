  ...
  integrations: [
    ...
    starlight({
      ...
      sidebar: [
        ...
        {
          label: '所有・運営・維持管理の全体構造',
          items: [
            { label: '業務レイヤーの全体像', slug: 'management-structure' },
            {
              label: '管理対象と計画期間',
              link: '/management-structure/#管理対象と計画期間',
            },
            {
              label: 'レイヤー間の情報循環',
              link: '/management-structure/#レイヤー間の情報循環',
            },
          ],
        },
        {
        ...
        {
          label: '維持管理・実行 ― ビルメンテナンス',
          collapsed: true,
          items: [
            { label: 'ビルメンテナンスの位置付け', slug: 'management-structure/maintenance-execution' },
